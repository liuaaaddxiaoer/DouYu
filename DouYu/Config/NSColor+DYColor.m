...
#import "NSColor+DYColor.h"

#import <AppKit/AppKit.h>


@implementation NSColor (DYColor)
+ (NSColor *)dy_mainColor {
    return [NSColor redColor];
}

+ (NSColor *)dy_borderColor {
    return [NSColor dy_colorWithHexString:@"e5e5e5"];
}



+ (NSColor *)dy_colorWithHexString:(NSString *)color alpha:(CGFloat)alpha
{
    //删除字符串中的空格
